...
class LatestProductsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => getIt<LatestProductsProvider>()
        ..loadProducts(),
      child: const _LatestProductsView(),
    );
  }
}
...
class _LatestProductsView extends StatelessWidget {
  const _LatestProductsView();
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: Consumer<LatestProductsProvider>(
          builder: (
              context,
              provider,
              child,
...
class _Pagination extends StatelessWidget {
  ...
  final LatestProductsProvider provider;
